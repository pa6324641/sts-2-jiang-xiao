...
public class ResentmentPower : CustomPowerModel
{
    ...
    private async Task ApplyRandomDebuff(PlayerChoiceContext context, Creature dealer)
    {
        ...
        switch (roll)
        {
            ...
            case 4: await PowerCmd.Apply<PoisonPower>(dealer, varAmount * 5, Owner, null); break; // 毒稍微給多一點
            case 5: await PowerCmd.Apply<DoomPower>(dealer, varAmount * 5, Owner, null); break;
